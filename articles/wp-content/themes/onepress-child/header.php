...
/**
 * The header for the OnePress Child theme.
 *
...
<body <?php body_class(); ?>>
	...
	<div class="back-to-main-site-container">
		<div class="container">
			<a href="<?php echo esc_url( get_theme_mod( 'onepress_child_main_site_url', 'https://izendestudioweb.com/' ) ); ?>"
			   class="back-to-main-site-link"
			   aria-label="<?php esc_attr_e( 'Return to main website', 'onepress-child' ); ?>">
				<i class="fa fa-arrow-left"></i> <?php echo esc_html( get_theme_mod( 'onepress_child_main_site_text', 'Main Site' ) ); ?>
			</a>
		</div>
	</div>
