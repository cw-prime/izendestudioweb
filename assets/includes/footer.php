...
?>
  ...
  <footer id="footer">
    <div class="container">
      ...
      <!-- Social links + BBB Accredited Business seal, side by side -->
      <div class="footer-social-bbb" style="display:flex; flex-wrap:wrap; align-items:center; justify-content:center; gap:20px; margin-top:8px;">
  ...
  <a href="#" class="back-to-top d-flex align-items-center justify-content-center"><i
    ...
    (function() {
        ...
        const serviceRadiusMeters = 24140; // ~15 miles
