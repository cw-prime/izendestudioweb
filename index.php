...
<body id="home"
  ...
  <section id="hero" class="hero-modern">
    ...
    <!-- Subtle nature-inspired SVG decorative elements - loaded from separate files to avoid ModSecurity blocking -->
    <!-- Bamboo stems - bottom left -->
    <img src="assets/svg/hero-bamboo.svg" class="hero-decoration-bamboo" style="position: absolute; bottom: 0; left: 0; width: 300px; height: 300px; opacity: 0.12; z-index: 0; pointer-events: none;" alt="Bamboo decoration" loading="lazy">
    <!-- Waterfall/Stream - top right -->
    <img src="assets/svg/hero-waterfall.svg" class="hero-decoration-waterfall" style="position: absolute; top: 80px; right: 50px; width: 350px; height: 400px; opacity: 0.15; z-index: 0; pointer-events: none;" alt="Waterfall decoration" loading="lazy">
    <!-- Mountain silhouette - bottom right -->
    <img src="assets/svg/hero-mountain.svg" class="hero-decoration-mountain" style="position: absolute; bottom: 0; right: 80px; width: 400px; height: 300px; opacity: 0.15; z-index: 0; pointer-events: none;" alt="Mountain decoration" loading="lazy">
    <!-- Cloud shapes - top left -->
    <img src="assets/svg/hero-cloud.svg" class="hero-decoration-cloud" style="position: absolute; top: 50px; left: 8%; width: 280px; height: 140px; opacity: 0.12; z-index: 0; pointer-events: none;" alt="Cloud decoration" loading="lazy">
    ...
    <section class="cta-section zen-cta" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 60px 0; color: white; position: relative; overflow: hidden;">
      <div class="cta-illustrations" aria-hidden="true">
        <!-- Bamboo silhouette -->
        <img src="assets/svg/cta-bamboo.svg" class="cta-bamboo" alt="Bamboo decoration" loading="lazy">
        <!-- Cloud -->
        <img src="assets/svg/cta-cloud.svg" class="cta-cloud" alt="Cloud decoration" loading="lazy">
        <!-- Bonsai -->
        <img src="assets/svg/cta-bonsai.svg" class="cta-bonsai" alt="Bonsai decoration" loading="lazy">
      </div>
      <div class="container">
