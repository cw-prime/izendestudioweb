...
<body id="home"
  ...
  <section id="hero" class="hero-modern">
    ...
    <svg class="hero-decoration-bamboo" style="position: absolute; bottom: 0; left: 0; width: 300px; height: 300px; opacity: 0.12; z-index: 0; pointer-events: none;" viewBox="0 0 300 300" xmlns="http://www.w3.org/2000/svg">
    ...
    <svg class="hero-decoration-waterfall" style="position: absolute; top: 80px; right: 50px; width: 350px; height: 400px; opacity: 0.15; z-index: 0; pointer-events: none;" viewBox="0 0 300 400" xmlns="http://www.w3.org/2000/svg">
      <!-- Rock cliff -->
    ...
    <svg class="hero-decoration-mountain" style="position: absolute; bottom: 0; right: 80px; width: 400px; height: 300px; opacity: 0.15; z-index: 0; pointer-events: none;" viewBox="0 0 400 300" xmlns="http://www.w3.org/2000/svg">
    ...
    <svg class="hero-decoration-cloud" style="position: absolute; top: 50px; left: 8%; width: 280px; height: 140px; opacity: 0.12; z-index: 0; pointer-events: none;" viewBox="0 0 280 140" xmlns="http://www.w3.org/2000/svg">
      <!-- Large fluffy cloud -->
    ...
    <section class="cta-section zen-cta" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 60px 0; color: white; position: relative; overflow: hidden;">
      <div class="cta-illustrations" aria-hidden="true">
        <!-- Bamboo silhouette -->
        <svg class="cta-bamboo" viewBox="0 0 200 260" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- Cloud -->
        <svg class="cta-cloud" viewBox="0 0 260 140" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- Bonsai -->
        <svg class="cta-bonsai" viewBox="0 0 240 220" xmlns="http://www.w3.org/2000/svg">
          <path d="M120,210 Q130,170 120,140 Q110,110 120,80 Q135,45 120,20" stroke="#d0e6d6" stroke-width="12" stroke-linecap="round" fill="none" opacity="0.45"/>
          <ellipse cx="110" cy="50" rx="46" ry="32" fill="#d8eadf" opacity="0.5"/>
          <ellipse cx="150" cy="90" rx="38" ry="26" fill="#d0e6d6" opacity="0.4"/>
          <ellipse cx="90" cy="100" rx="34" ry="24" fill="#d0e6d6" opacity="0.4"/>
          <rect x="80" y="210" width="80" height="10" rx="4" fill="#d0e6d6" opacity="0.5"/>
        </svg>
      </div>
      <div class="container">
